 ...
 */
class MyGrizzlyServerFilter extends BaseFilter {

    private static final Logger LOGGER = Grizzly.logger(MyGrizzlyServerFilter.class);

    private static final Attribute<org.glassfish.tyrus.spi.Connection> TYRUS_CONNECTION =
            Grizzly.DEFAULT_ATTRIBUTE_BUILDER
                    .createAttribute(MyGrizzlyServerFilter.class.getName() + ".Connection");
     ...
     */
    public MyGrizzlyServerFilter(ServerContainer serverContainer, String contextPath) {
